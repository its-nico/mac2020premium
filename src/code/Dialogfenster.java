...
public class Dialogfenster { //In dieser Klasse werden die Dialogfenster zu verschiedenen Warnungen und Fehlern erstellt
    ...
    public void verbindungWirdAufgebaut() {
        ...
        JOptionPane.showMessageDialog(null, message, "Verbindungsaufbau", JOptionPane.INFORMATION_MESSAGE); //Es handelt sich um ein Informationsfenster
    }
    ...
    public void datenbankListeNichtGeändert() {
        ...
        int result = JOptionPane.showConfirmDialog(null, message, "Hochladen bestätigen", JOptionPane.YES_NO_OPTION); //Nutzer*innen müssen sich zwischen JA/Nein entscheiden
        switch (result) {
            case JOptionPane.YES_OPTION:
                /*try {
